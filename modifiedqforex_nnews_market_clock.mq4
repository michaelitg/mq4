...
//---- parse date and time from array
   ...
   //-----------------------------------------------------  
   string GMTs = myTimeToString( GMT );
   string locals = myTimeToString( localTime  );
   string londons = myTimeToString( london  );
   string frankfurts = myTimeToString( frankfurt );
   string tokyos = myTimeToString( tokyo  );
   string newyorks = myTimeToString( newyork  );
   string sydneys = myTimeToString ( sydney );
   string aucklands = myTimeToString( auckland );
   string hongkongs = myTimeToString( hongkong );
   string brokers = myTimeToString( CurTime() );
...
int DisplayTodaysNews()
{
   ...
   {   
     ...
     InitNews(news,time_zone_gmt+5,news_url ); 
     if(show_news_lines)
     {
...
//+------------------------------------------------------------------+
string myTimeToString( datetime when ) {
   if ( !show12HourTime )
